...
data = os.path.join(root_dir, dataset, 'preprocessed_identity_pointnet_normales',name)
...
data_dir = os.path.join(root_dir, dataset, 'preprocessed_identity_pointnet_normales',name)
normalization = True
meshpackage = 'trimesh'